...
<div class="container pt-5">
    <h3>SOMTURK Event Gallery</h3>
    <form action="event-imageUpload.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
...
//Upcoming events
	 $query = sprintf("SELECT * FROM tbl_image_events" );
...
function checkDelete(){
    return confirm('Are you sure To delete?');
                ...
                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                    <a class="thumbnail fancybox" rel="ligthbox" href="../events/<?php echo $rs_images[$image]["image"]; ?>">
                        <img class="img-responsive" alt="" src="../events/<?php echo $rs_images[$image]["image"]; ?>" />
                        <div class='text-center'>
                            <small class='text-muted'><?php echo $rs_images[$image]["title"]; ?></small>
                        </div> <!-- text-center / end -->
                    </a>					
					<a onclick="return checkDelete()" href="event-imageDelete.php?image-id=<?php echo $rs_images[$image]["id"]; ?>"                    
