<div class="header-area">
      <div class="container"> 
        <!-- Site logo Start -->
        <div class="logo"> <a href="index.php" title="Somturk"><img src="assets/images/logo.png" alt="Somturk"/></a> </div><div class="logo"> <img src="assets/images/slogan.png" alt="Somturk"/></div>
        <!-- Site logo end -->
        ...
        <nav class="mainmenu">
          <ul id="navigation">
            <li class="nav-active"><a href="index.php">Home</a>
            ...
            <li><a href="vission.php">Vision</a>
