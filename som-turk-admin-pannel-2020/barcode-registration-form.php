...
<main class="pl-1 pt-1">
	<div class="container">
		...
		<div class="card card-cascade narrower">        
			...
			<div class="card-body">
				<!-- Register form -->
				<form name="form1" action="barcode.php" method="post" enctype="multipart/form-data">
					<p class="h5 text-center mb-0">Barcode Registration Form</p>
					<hr class="light-blue lighten-1 title-hr">
					<div class="md-form">						
                  ...
                  <input name="registration_date" type="text" id="datepicker" placeholder="Registration Date" class="form-control" required>                  
						...
						<select name="country_name" class=" form-control pl-5" required>
							...
							<?php 
								...
								<option value="<?php echo $rs_country[$i]["country_name"]; ?>"><?php echo $rs_country[$i]["country_name"]; ?></option>
								<?php 
								} 
							?>
						</select>
					 ...
					 <div class="md-form">
						...
						<input  name="shipping_model" type="text" id="shipping_model" class="form-control" placeholder="Shipping Model">                 
					</div>
					...
					<div class="md-form">
						<i class="fas fa-barcode prefix grey-text"></i>
						<input  name="b_code" type="text" id="b_code" class="form-control" placeholder="Barcode">                 
					</div>
					
					<div class="md-form">
						<i class="fas fa-print prefix grey-text"></i>
						<input name="print_qty" type="text" id="print_qty" class="form-control" placeholder="Print Quantity">               
					</div>
					<div class="md-form">
						<i class="fas fa-phone-volume prefix grey-text"></i>
						<input name="tel" type="text" id="tel" class="form-control" placeholder="Telefone">               
					</div>
